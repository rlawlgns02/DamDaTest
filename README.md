...
모든 화면의 명함은 가로:세로 9:5 비율을 유지합니다. PNG 앞뒷면은 같은 비율의 1440×800 이미지로, VCF와 함께 브라우저에서 생성합니다. QR과 복사 주소는 목업 홈페이지로만 연결되며, 개인 명함 데이터가 들어가지 않습니다. PNG는 디자인 확인용 이미지이며 웹 명함과 내보내기의 글꼴·행간은 다를 수 있습니다.
